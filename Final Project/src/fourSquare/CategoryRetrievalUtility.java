...
public class CategoryRetrievalUtility {
		...
		public CategoryRetrievalUtility(){
			...
			subCategory1.add("Soccer Field");

			subCategory1.add("Tennis");
			subCategory1.add("Arts & Entertainment");
			...
			subCategory2.add("College & University");		
			CATEGORY.put("College & University", subCategory2);


			subCategory3.add("Afghan Restaurant");
			...
			subCategory3.add("Café");
			subCategory3.add("Cajun / Creole Restaurant");
			...
			subCategory3.add("Food");
			subCategory3.add("Health Food Store");
			...
			subCategory4.add("Campaign Office");
			...
			subCategory4.add("Radio Station");
			...
			subCategory6.add("Other Great Outdoor");
			...
			subCategory6.add("Rock Climbing Spot");
			...
			subCategory6.add("Paintball Field");
			subCategory6.add("Skate Park");
			subCategory6.add("Skating Rink");
			subCategory6.add("Tennis Court");
			subCategory6.add("Volleyball Court");
			subCategory6.add("Parks & Outdoors");
			subCategory6.add("Outdoors & Recreation");
			subCategory6.add("Outdoor & Recreation");
			subCategory6.add("Castle");
			subCategory6.add("Theme Park");
			subCategory6.add("Water Park");
			...
			subCategory7.add("EV Charging Station");
			subCategory7.add("Electronics Store");
			subCategory7.add("Financial or Legal Service");
			...
			subCategory7.add("Motorcycle Shop");
			...
			subCategory7.add("Shops & Service");
			...
			subCategory8.add("Travel & Transport");
			...
			subCategory9.add("Residence");
			subCategory9.add("Residential Building (Apartment / Condo)");
